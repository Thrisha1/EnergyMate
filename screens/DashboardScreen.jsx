    ...
    <>
      <SafeAreaView className="bg-[#4C7380]  flex-1">
        ...
        <View className="bg-[#D8E4E8] h-40 justify-around opacity-75 rounded-xl mx-5">
          <Image source={require("../assets/welcome.png")} className="mx-6" />
        ...
        <View className="bg-[#efeeee] h-2/5 w-full my-5 rounded-t-3xl p-5">
          ...
          <View className="h-36 justify-between py-3 shadow-2xl">
            <TouchableOpacity
              onPress={() => navigation.navigate("AvailableDevices")}
              className="w-full shadow-xl bg-white py-3 rounded-xl px-3 flex-row"
            >
